...
KISBPM.TOOLBAR_CONFIG = {
    "items" : [
       {
    	   "type" : "button",
    	   "title" : "TOOLBAR.ACTION.NEW",
    	   "cssClass" : "editor-icon icon-file",
    	   "action" : "KISBPM.TOOLBAR.ACTIONS.newModel"
       },
        {
            "type" : "button",
        ...
        },
       {
        ...
        },
        {
            ...
            "cssClass" : "editor-icon icon-copy",
        ...
        },
        {
            ...
            "cssClass" : "editor-icon icon-paste",
        ...
        },
        {
            ...
            "cssClass" : "editor-icon icon-trash",
        ...
        },
        {
            ...
            "cssClass" : "editor-icon icon-repeat",
        ...
        },
        {
            ...
            "cssClass" : "editor-icon icon-undo",
        ...
        */
        ...
        },
    	{
            ...
            "cssClass" : "editor-icon  icon-plus-sign",//editor-icon-bendpoint-add
        ...
        ,
    	{
    	    ...
    	    "cssClass" : "editor-icon icon-minus-sign",//editor-icon-bendpoint-remove
    	    //"cssClass" : "editor-icon editor-icon-bendpoint-setGlobal",
    	...
    	{
    	    "type" : "button",
    	    "title" : "TOOLBAR.ACTION.BENDPOINT.SETGLOBAL",
    	    "cssClass" : "editor-icon icon-wrench",
    	    "action" : "KISBPM.TOOLBAR.ACTIONS.setGlobalProperties",
    	    "id" : "setGlobal-bendpoint-button"
    	}
    ]
/*
,
