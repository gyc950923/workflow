    	...
    	<div data-options="region:'center',border:false">
    		<div id="resultGrid_tb">
				<form id="resultGrid_queryForm">
					&nbsp;&nbsp;表单名称：<input id="name" name="name" class="easyui-textbox" style="width: 170px;">&nbsp;
    		...
    		<table class="easyui-datagrid" id="resultGrid"
		        data-options="
			        fit:true,
			        url:'<%=path%>/wf/business/getAllFormsByPage',
			    ...
			    <thead>   
			        <tr>
			            ...
			            <th data-options="field:'url',width:100,halign:'center'">地址</th>   
			        </tr>   
			    </thead>   
			</table>
    	</div>   
