...
(function($) {
	...
	function _97(_98) {
		...
		t.attr("id", _99.id || "");
		t.attr("permission", _99.permission);
...
(function($) {
	...
	function _9eb(_9f1, _9f2, _9f3) {
		...
		if (!$.isArray(_9f2)) {
			/*
			 * 修改日期：20117-11-29 修改人：lils 修改原因：
			 * 当修改编辑表单时，当value值为null时，split函数会报错， 所以在这个地方做了条件表达式处理
			 */
			_9f2 = null == _9f2 ? "" : _9f2;
		...
		for (var i = 0; i < _9f2.length; i++) {
			...
			/*
			 * 修改日期：2018-01-23 修改人：lils 修改云因：由于多选时 多选框开头总是多一个逗号，所以加上此句判断
			 */
			if (!s)
				continue;
			vv.push(v);
		...
		buttons : [
				{
					...
					text : function(_abf) {
						return $(_abf).datebox("options").clearText;
					},
					handler : function(_abg) {
						$(_abg).datebox("setValue", "");
	...
	$.fn.datetimebox.defaults = $.extend({}, $.fn.datebox.defaults,
			{
				...
				buttons : [ {
					...
					text : function(_abf) {
						return $(_abf).datetimebox("options").clearText;
					},
					handler : function(_abg) {
						$(_abg).datetimebox("setValue", "");
						$(_abg).datetimebox("hidePanel");
					}
				}, {
					text : function(_ade) {
