...
(function($) {
						...
						$
								.extend(
										...
										_13.options,
										{
											...
											closed : true,
											cls : "window "
													+ (!_14.border ? "window-thinborder window-noborder "
															: (_14.border == "thin" ? "window-thinborder "
																	: ""))
													+ (_14.cls || ""),
											...
											onMinimize : function() {
												...
												_13.options.onMinimize
														.call(_12);
											},
											onBeforeCollapse : function() {
												if (_14.onBeforeCollapse
														.call(_12) == false) {
													return false;
												}
												if (_13.shadow) {
		...
		_1b.window
				.resizable({
					...
					onStartResize : function(e) {
						...
						_1b.proxy._outerWidth(e.data.width)._outerHeight(
								e.data.height);
					},
					onResize : function(e) {
						_1b.proxy.css({
	...
	$.fn.window.parseOptions = function(_26) {
		return $.extend({}, $.fn.panel.parseOptions(_26), $.parser
				.parseOptions(_26, [ {
					draggable : "boolean",
					resizable : "boolean",
					shadow : "boolean",
