    	...
    	<div data-options="region:'center',border:false">
    		<div id="resultGrid_tb">
				<form id="resultGrid_queryForm">
					&nbsp;&nbsp;实体名称：<input id="name" name="name" class="easyui-textbox" style="width: 170px;">&nbsp;
    		...
    		<table class="easyui-datagrid" id="resultGrid"
		        data-options="
			        fit:true,
			        url:'<%=path%>/wf/business/getAllEntitysByPage',
			    ...
			    <thead>   
			        <tr>
			            ...
			            <th data-options="field:'name',width:60,halign:'center'">实体名称</th>   
