...
<body>
	<div class="easyui-layout" data-options="fit:true">
    	<div data-options="region:'center',border:false">
    		<div id="resultGrid_tb">
				<form id="resultGrid_queryForm" action="" method="post">
					&nbsp;&nbsp;部门名称：<input id="name" name="name" class="easyui-textbox" style="width: 100px;">&nbsp;
    		...
    		<table class="easyui-treegrid" id="resultGrid" name="resultGrid"
		        data-options="
		        	fit:true,
		        	url:'<%=path%>/wf/business/getDeptInfoTree',
	...
	<script type="text/javascript">
		function query(formId){
			...
			$('#resultGrid').treegrid('load', queryData);
		}
