...
public class XmlUtil {
	 ...
	 * @return 转换后的对象
	 */
	public static Object xmlListStrToBean(String xmlStr, Class<?> clazz) {
		Object obj = null;
		try {
			// 将xml格式的数据转换成Map对象
	...
	public static Object xmlStrToBean(Element element, Class<?> clazz) throws Exception {
		Map<String, Object> m = new HashMap<String, Object>();
		Iterator iter1 = element.attributeIterator();
		while (iter1.hasNext()) {
			Attribute a = (Attribute) iter1.next();
			if (!StringUtils.isEmpty(a.getValue()) && !"null".equals(a.getValue())) {
